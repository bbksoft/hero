...
public class UITools
{
    ...
    public static void SetColorText(Transform t, string text,Color c)
    {
        if (t == null) return;
    ...
    public static void SetEnableDrag(Transform t, bool enable)
    {
        UIDragFun d = t.GetComponent<UIDragFun>();
        if (d!=null)
        {
            d.enabled = enable;
        }        
    ...
    public static GameObject AddMod(Transform t, string name, string res,float size,Vector3 faceto)
    {
    ...
    static public void EnableCom(Transform t, string com, bool value)
    {
        MonoBehaviour c = t.gameObject.GetComponent(com) as MonoBehaviour;
        c.enabled = value;
    }

    static public void EnableChildCom(Transform t, string child, string com, bool value)
    {
        EnableCom(t.FindChild(child), com, value);
    }

    static public void SetHPAnim(Transform t, float v)
    {
        HPAnim a = t.GetComponent<HPAnim>();
        a.SetValue(v);
    }

    static public void SetHPAnimAtOnce(Transform t, float v)
    {
        HPAnim a = t.GetComponent<HPAnim>();
        a.SetValueAtOnce(v);
    }
