...
public class GameAPIWrap
{
	...
	static int LinkEffect(IntPtr L)
	{
		try
		{
			...
			else if (count == 6 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.GameObject), typeof(UnityEngine.GameObject), typeof(UnityEngine.GameObject), typeof(string), typeof(float), typeof(float)))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
				UnityEngine.GameObject arg1 = (UnityEngine.GameObject)ToLua.ToObject(L, 2);
				UnityEngine.GameObject arg2 = (UnityEngine.GameObject)ToLua.ToObject(L, 3);
				...
				GameAPI.LinkEffect(arg0, arg1, arg2, arg3, arg4, arg5);
				return 0;
			}
			else
			{
