...
public class GameAPI {
    ...
    static T GetOrAnd<T>(GameObject obj) where T : Component
    {
    ...
    static public void AddOffAnim(GameObject obj, Vector3 off)
    {
    ...
    static public void LinkEffect(GameObject obj, GameObject src, GameObject des, string node, float nodeDes, float time)
    {
        LinkEffect e = obj.AddComponent<LinkEffect>();
        e.src = src;
        e.des = des;
    ...
    {
        Shake a = GetOrAnd<Shake>(Camera.main.gameObject);
        a.time = time;
        a.power = power;
    }
