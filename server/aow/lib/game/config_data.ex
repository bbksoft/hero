...
defmodule Cfg_actor do
	...
	def size(record) when is_tuple(record) do
		elem(record,3)
	end
	def size(id) do
	...
	def skill_loop(id) do
		Cfg.get_field(:cfg_actor,id,14)
	end
end
defmodule Cfg_actor_sound do

	def get(id) do
		Cfg.get(:cfg_actor_sound,id)
	end
	...
	def match(list) do
		q = {:"_",:"_",:"_"}
		Cfg.match(:cfg_actor_sound,list,q,fn(x)-> get_field_id(x) end)
	end

	def find(list) do
		q = {:"$1",:"$2",:"$3"}
		Cfg.find(:cfg_actor_sound,list,q,fn(x)-> get_field_id(x) end)
	end
	...
	def id(id) do
		Cfg.get_field(:cfg_actor_sound,id,0)
	end

	def anim(record) when is_tuple(record) do
		elem(record,1)
	end
	def anim(id) do
		Cfg.get_field(:cfg_actor_sound,id,1)
	end

	def name(record) when is_tuple(record) do
		elem(record,2)
	end
	def name(id) do
		Cfg.get_field(:cfg_actor_sound,id,2)
	end
end
...
defmodule Cfg_start do

	def get(id) do
		Cfg.get(:cfg_start,id)
	end
	...
	def match(list) do
		q = {:"_",:"_"}
		Cfg.match(:cfg_start,list,q,fn(x)-> get_field_id(x) end)
	end

	def find(list) do
		q = {:"$1",:"$2"}
		Cfg.find(:cfg_start,list,q,fn(x)-> get_field_id(x) end)
	end
	...
	def id(id) do
		Cfg.get_field(:cfg_start,id,0)
	end

	def value(record) when is_tuple(record) do
		elem(record,1)
	end
	def value(id) do
		Cfg.get_field(:cfg_start,id,1)
	end
end
defmodule Cfg_game do
	...
	def match(list) do
		q = {:"_",:"_",:"_",:"_"}
		Cfg.match(:cfg_game,list,q,fn(x)-> get_field_id(x) end)
	end

	def find(list) do
		q = {:"$1",:"$2",:"$3",:"$4"}
		Cfg.find(:cfg_game,list,q,fn(x)-> get_field_id(x) end)
	end
	...
	def id(id) do
		Cfg.get_field(:cfg_game,id,0)
	end

	def creaters(record) when is_tuple(record) do
		elem(record,1)
	end
	def creaters(id) do
		Cfg.get_field(:cfg_game,id,1)
	end

	def power(record) when is_tuple(record) do
		elem(record,2)
	end
	def power(id) do
		Cfg.get_field(:cfg_game,id,2)
	end

	def boss(record) when is_tuple(record) do
		elem(record,3)
	end
	def boss(id) do
		Cfg.get_field(:cfg_game,id,3)
	end
end
...
defmodule Cfg_m_creater do

	def get(id) do
		Cfg.get(:cfg_m_creater,id)
	end
	...
	def match(list) do
		q = {:"_",:"_",:"_",:"_"}
		Cfg.match(:cfg_m_creater,list,q,fn(x)-> get_field_id(x) end)
	end

	def find(list) do
		q = {:"$1",:"$2",:"$3",:"$4"}
		Cfg.find(:cfg_m_creater,list,q,fn(x)-> get_field_id(x) end)
	end
	...
	def id(id) do
		Cfg.get_field(:cfg_m_creater,id,0)
	end

	def actors(record) when is_tuple(record) do
		elem(record,1)
	end
	def actors(id) do
		Cfg.get_field(:cfg_m_creater,id,1)
	end

	def actors_p(record) when is_tuple(record) do
		elem(record,2)
	end
	def actors_p(id) do
		Cfg.get_field(:cfg_m_creater,id,2)
	end
	...
	def count(id) do
		Cfg.get_field(:cfg_m_creater,id,3)
	end
end
...
defmodule Cfg_master_skill do
	...
	def need_link(record) when is_tuple(record) do
		elem(record,7)
	end
	def need_link(id) do
